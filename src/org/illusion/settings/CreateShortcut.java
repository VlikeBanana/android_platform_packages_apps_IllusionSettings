...
public class CreateShortcut extends LauncherActivity {
    ...
    protected Intent getTargetIntent() {
        ...
        targetIntent.addCategory("org.illusion.settings.SHORTCUT");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        shortcutIntent.setAction("org.illusion.settings.START_NEW_FRAGMENT");
        shortcutIntent.putExtra("illusion_fragment_name", intentClass);
